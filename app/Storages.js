var Storages = {
	buildings: { 
		...
		tier4: {
			likes: new Building('storage for likes', ['upgradable'], 1.6, 'likes', function(){return 1;}, resources_rates['likes'], "Expands the maximum size of the likes."),
			design: new Building('storage for design', ['upgradable'], 1.6, 'design', function(){return 1;}, resources_rates['design'], "Expands the maximum size of the design."),
			money: new Building('storage for money', ['upgradable'], 1.6, 'money', function(){return 1;}, resources_rates['money'], "Expands the maximum size of the money."),
			ideas: new Building('storage for ideas', ['upgradable'], 1.6, 'ideas', function(){return 1;}, resources_rates['ideas'], "Expands the maximum size of the ideas.")
		} 
	}	
};
