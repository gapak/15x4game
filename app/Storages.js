        ...
        storages_html += `
          <div class="flex-element ${secret_class}" id="sold_for_${resource}_1_container">
            ${sb.tier1[resource].name}: ${sb.tier1[resource].level}
              <button class="btn btn-default" onclick = "Storages.upgradeBuilding(1, '${resource}')">Up1:
        ...
        storages_html += `
          <div class="flex-element ${secret_class}">
            ${sb.tier2[resource].name}: ${sb.tier2[resource].level}
              <button class="btn btn-default" onclick = "Storages.upgradeBuilding(2, '${resource}')">Up2: 
        ...
        storages_html += `
          <div class="flex-element ${secret_class}">
            ${sb.tier3[resource].name}: ${sb.tier3[resource].level}
              <button class="btn btn-default" onclick = "Storages.upgradeBuilding(3, '${resource}')">Up3:
        ...
        storages_html += `
          <div class="flex-element ${secret_class}">
            ${sb.tier4[resource].name}:  ${sb.tier4[resource].level} 
              <button class="btn btn-default" onclick = "Storages.upgradeBuilding(4, '${resource}')">Up4:
