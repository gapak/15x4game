...
var objectives = {};
objectives.db = [
    new Objective('sold for knowledge 1', 'Perseverance', 'Description', ['learn 1'], {knowledge: 10}),
    new Objective('sold for knowledge 2', 'Discipline', 'Description', ['learn 2', 'sold for knowledge 1'], {knowledge: 20}),
    new Objective('sold for knowledge 3', 'Motivation', 'Description', ['learn 3', 'sold for knowledge 2'], {knowledge: 30}),
    new Objective('sold for knowledge 4', 'Purposefulness', 'Description', ['learn 4', 'sold for knowledge 3'], {knowledge: 40}),
    ...
    new Objective('sold for likes 4', 'Site', 'Let all information about you knowledge be available in one place', ['sold for likes 3'], {likes: 4000}),
    ...
    new Objective('sold for ideas 2', 'Astro-event', 'Ideas knowledge not fall down from the sky', ['sold for ideas 1'], {ideas: 2}),
    new Objective('sold for ideas 3', 'Party', 'The best ideas are born during leisure', ['sold for ideas 2'], {ideas: 3}),
    new Objective('sold for ideas 4', 'Festival', 'You knowledge be very experienced if you don\'t die', ['sold for ideas 3'], {ideas: 4}),
